...
BinaryParser.prototype.seek = function (offset, whence) {
  switch (whence) {
    case 'set': case null: case undefined:
      this.cursor = offset; break
    case 'cur': case 'current':
      this.cursor += offset; break
    case 'end':
      this.cursor = this.buffer.byteLength + offset; break
    default:
